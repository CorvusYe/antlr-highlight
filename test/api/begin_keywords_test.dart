...
Mode grammarWithFollowupRule = Mode(contains: [
...
void main() {
  ...
  group('beginKeywords', () {
    test('should allow subsequence matches to still succeed', () {
      ...
      final HighlightResult res =
          highlight.highlight(code: content, language: 'has-followup');
    ...
    test('should ignore a preceeding .', () {
      const String content = 'A.class = self';
      final HighlightResult res =
          highlight.highlight(code: content, language: 'test');
